    ...
    private fun pickColor(position: Float, canvasWidth: Int): Int {
        ...
        when {
            ...
            value >= 1 -> return colorSeeds[colorSeeds.size - 1]
                ...
                Log.d("M_CUSTOM_COLOR","before manipulation colorPosition: $colorPosition, ")
                ...
                Log.d("M_CUSTOM_COLOR","position: $position, colorPosition: $colorPosition, color0: $c0, color1: $c1 value: $value")
